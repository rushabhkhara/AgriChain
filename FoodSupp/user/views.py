...
address = web3.toChecksumAddress('0x69ee8f2ae3dc395b6702bb8d34a06e704924ece7')
...
address1 = web3.toChecksumAddress('0x81581a3ea2e60daf6df157bc66d11d444b1810c9')
...
def retailer(request):
    ...
    if data.each() != None:
        for entry in data.each():
            ...
            for key, value in product.items():
                ...
                qrPath = "D:/PyCharmProjects/AgriChain1/FoodSupp/user/static/Images/QRfiles/" + transactionKeys['transactionKey'] + ".svg"
    ...
    if request.method == "POST":
        if "broadcast" in request.POST:
            ...
            database.child("user").child("Retailer").child('Confirmed Processor Orders').child(retailerId).child(
                request.POST['dropdown1']).child(request.POST['dropdown2']).update({'broadcasted' : 1})
